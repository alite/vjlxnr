...
_(Sämtliche verfügbaren Parameter werden auf einer "separaten Seite":{{site.baseurl}}/docs/parameters/ aufgeführt.)_
...
!{{site.baseurl}}/docs/img/vjlxnr_img_scale_cut_formula.png!
...
!{{site.baseurl}}/docs/img/Bewegung_Videoplane.png!

Die maximalen Auslenkungen berechnen sich nach folgender Formel (Strahlensatz):

!{{site.baseurl}}/docs/img/formel_auslenkung.png!
